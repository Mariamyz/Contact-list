            ...
            <tbody>
              {Object.keys(statusCounts).map((status, index) => (
                <tr key={index}>
                  ...
                  <td className={`fs-4 fw-bold status-name-${status.toLowerCase()}`}>
                  ...
                  <td className={`fs-4 fw-bold status-count-${status.toLowerCase()}`}>
                  ...
                  <td>
                    <Link to={`/contact-statuss/edit-contact-status/${status}`}>
                      <button
                        className="btn btn-edit me-2 d-inline-flex align-items-center gap-1"
                      >
                        <FiEdit2 />
                        Edit
                      </button>
